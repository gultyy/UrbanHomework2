"""
    ...
    3. Основной задачей будет отделение первостоящей цифры в числе: создайте переменную first и запишите в неё первый
    ...
    числа на результат работы этой же функции c числом, но уже без первой цифры.
